...
class RWMB_Core {
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="https://metabox.io/docs/">' . __( 'Documentation', 'bizspeak' ) . '</a>';
		$links[] = '<a href="https://metabox.io/plugins/">' . __( 'Extensions', 'bizspeak' ) . '</a>';
		return $links;
	}
	...
	public function load_textdomain() {
		load_plugin_textdomain( 'bizspeak', false, plugin_basename( RWMB_DIR ) . '/languages/' );
	}
